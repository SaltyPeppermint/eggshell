...
//     ($name: ident, $type: ty) => {paste::paste! {

//         /// Manual wrapper (or monomorphization) of [`Eqsat`] to work around Pyo3 limitations
//         #[pyo3::pyclass]
//         #[derive(Debug, Clone, serde::Serialize)]
//         pub struct [<New $name Eqsat>] ($crate::eqsat::Eqsat<$type, $crate::eqsat::New>);

//         /// Manual wrapper (or monomorphization) of [`Eqsat`] to work around Pyo3 limitations
//         #[pyo3::pyclass]
//         #[derive(Debug, Clone, serde::Serialize)]
//         pub struct [<Finished $name Eqsat>] ($crate::eqsat::Eqsat<$type, $crate::eqsat::Finished>);
...
//             fn run(&mut self, start_term: &str) -> pyo3::PyResult<[<Finished $name Eqsat>]> {
...
monomorphize!(crate::trs::halide::Halide);
