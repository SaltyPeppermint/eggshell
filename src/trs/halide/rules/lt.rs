...
pub(crate) fn lt() -> Vec<Rewrite> {
    vec![
        ...
        rw!("lt-x-x-sub-a"  ;  "(< (- ?a ?y) ?a )"      => "1" if halide::is_const_pos("?y")),
        rw!("lt-const-pos"  ;  "(< 0 ?y )"              => "1" if halide::is_const_pos("?y")),
        rw!("lt-const-neg"  ;  "(< ?y 0 )"              => "1" if halide::is_const_neg("?y")),
        ...
        rw!("lt-min-term+cpos"      ; "( < ( min ?x ?y ) (+ ?x ?c0) )"              => "1" if halide::is_const_pos("?c0")),
        ...
        rw!("lt-const-mod"     ; "(< ?a (% ?x ?b))" => "1"  if halide::compare_constants("?a", "?b", "<=-a")),
        rw!("lt-const-mod-false"     ; "(< ?a (% ?x ?b))" => "0"  if halide::compare_constants("?a", "?b", ">=a")),
    ]
}
