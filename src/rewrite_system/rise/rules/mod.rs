...
pub fn mm_rules() -> Vec<Rewrite<Rise, RiseAnalysis>> {
    let mut algorithmic = vec![
        ...
        rewrite!("map-fusion"; "(typeOf (app (typeOf (app (typeOf map ?tAny) (typeOf ?e0 (fun ?dt0 ?dt1))) ?tAny) (typeOf (app (typeOf (app (typeOf map ?tAny) (typeOf ?e1 (fun ?dt2 ?dt0))) ?tAny) (typeOf ?e2 (arrT ?n0 ?dt2))) (arrT ?n0 ?dt0))) (arrT ?n0 ?dt1))" => { Shifted::new("?1", "?4", 1, 0, Shifted::new("?0", "?3", 1, 0, Shifted::new("?dt1", "?dt4", 1, 0, Shifted::new("?dt2", "?dt5", 1, 0, Shifted::new("?dt0", "?dt3", 1, 0, pat("(typeOf (app (typeOf (app (typeOf map (fun (fun ?dt2 ?dt1) (fun (arrT ?n0 ?dt2) (arrT ?n0 ?dt1)))) (typeOf (lam (typeOf (app (typeOf ?e3 (fun ?dt3 ?dt4)) (typeOf (app (typeOf ?e4 (fun ?dt5 ?dt3)) (typeOf %0 ?dt5)) ?dt3)) ?dt4)) (fun ?dt2 ?dt1))) (fun (arrT ?n0 ?dt2) (arrT ?n0 ?dt1))) (typeOf ?e2 (arrT ?n0 ?dt2))) (arrT ?n0 ?dt1))")))))) }),
        rewrite!("map-eta-abstraction"; "(typeOf (app (typeOf map ?tAny) (typeOf ?e0 (fun ?dt0 ?dt1))) (fun (arrT ?n0 ?dt0) (arrT ?n0 ?dt1)))" => { Shifted::new("?0", "?1", 1, 0, Shifted::new("?n0", "?n1", 1, 0, Shifted::new("?dt0", "?dt2", 1, 0, Shifted::new("?dt1", "?dt3", 1, 0, pat("(typeOf (lam (typeOf (app (typeOf (app (typeOf map (fun (fun ?dt2 ?dt3) (fun (arrT ?n1 ?dt2) (arrT ?n1 ?dt3)))) (typeOf ?e1 (fun ?dt2 ?dt3))) (fun (arrT ?n1 ?dt2) (arrT ?n1 ?dt3))) (typeOf %0 (arrT ?n1 ?dt2))) (arrT ?n1 ?dt3))) (fun (arrT ?n0 ?dt0) (arrT ?n0 ?dt1)))"))))) }),
        rewrite!("vec-32-after-f32"; "(typeOf ?e0 (arrT ?n0 f32))" => { Shifted::new("?n0", "?n1", 1, 0, pat("(typeOf (app (typeOf asScalar (fun (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 f32)) (arrT ?n0 f32))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 (natMul (natPow 32 -1) ?n1)) f32) (arrT (natMul (natPow 32 -1) ?n1) (vecT %0 f32))))) 32) (fun (arrT ?n0 f32) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 f32)))) (typeOf ?e0 (arrT ?n0 f32))) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 f32)))) (arrT ?n0 f32))")) }),
        rewrite!("vec-32-after-(f32, f32)"; "(typeOf ?e0 (arrT ?n0 (pairT f32 f32)))" => { Shifted::new("?n0", "?n1", 1, 0, pat("(typeOf (app (typeOf asScalar (fun (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 f32))) (arrT ?n0 (pairT f32 f32)))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 (natMul (natPow 32 -1) ?n1)) (pairT f32 f32)) (arrT (natMul (natPow 32 -1) ?n1) (vecT %0 (pairT f32 f32)))))) 32) (fun (arrT ?n0 (pairT f32 f32)) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 f32))))) (typeOf ?e0 (arrT ?n0 (pairT f32 f32)))) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 f32))))) (arrT ?n0 (pairT f32 f32)))")) }),
        rewrite!("vec-32-after-(f32, (f32, f32))"; "(typeOf ?e0 (arrT ?n0 (pairT f32 (pairT f32 f32))))" => { Shifted::new("?n0", "?n1", 1, 0, pat("(typeOf (app (typeOf asScalar (fun (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 (pairT f32 f32)))) (arrT ?n0 (pairT f32 (pairT f32 f32))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 (natMul (natPow 32 -1) ?n1)) (pairT f32 (pairT f32 f32))) (arrT (natMul (natPow 32 -1) ?n1) (vecT %0 (pairT f32 (pairT f32 f32))))))) 32) (fun (arrT ?n0 (pairT f32 (pairT f32 f32))) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 (pairT f32 f32)))))) (typeOf ?e0 (arrT ?n0 (pairT f32 (pairT f32 f32))))) (arrT (natMul (natPow 32 -1) ?n0) (vecT 32 (pairT f32 (pairT f32 f32)))))) (arrT ?n0 (pairT f32 (pairT f32 f32))))")) }),
        rewrite!("vec-before-map-f32"; "(typeOf (app (typeOf (natApp (typeOf asVector ?tAny) ?n0) ?tAny) (typeOf (app (typeOf (app (typeOf map ?tAny) (typeOf ?e0 (fun f32 f32))) ?tAny) (typeOf ?e1 (arrT ?n1 f32))) (arrT ?n2 f32))) (arrT ?n3 (vecT ?n0 f32)))" => { VectorizeScalarFun::new("?0", "?n0", "?2", Shifted::new("?n3", "?n4", 1, 0, ComputeNatCheck::new("?n1", "(natMul ?n3 ?n0)", ComputeNatCheck::new("?n2", "(natMul ?n3 ?n0)", pat("(typeOf (app (typeOf (app (typeOf map (fun (fun (vecT ?n0 f32) (vecT ?n0 f32)) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (vecT ?n0 f32))))) (typeOf ?e2 (fun (vecT ?n0 f32) (vecT ?n0 f32)))) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (arrT ?n3 (vecT ?n0 f32)))"))))) }),
        rewrite!("vec-before-map-f32xf32"; "(typeOf (app (typeOf (natApp (typeOf asVector ?tAny) ?n0) ?tAny) (typeOf (app (typeOf (app (typeOf map ?tAny) (typeOf ?e0 (fun (pairT f32 f32) f32))) ?tAny) (typeOf ?e1 (arrT ?n1 (pairT f32 f32)))) (arrT ?n2 f32))) (arrT ?n3 (vecT ?n0 f32)))" => { VectorizeScalarFun::new("?0", "?n0", "?2", Shifted::new("?n3", "?n4", 1, 0, ComputeNatCheck::new("?n1", "(natMul ?n3 ?n0)", ComputeNatCheck::new("?n2", "(natMul ?n3 ?n0)", pat("(typeOf (app (typeOf (app (typeOf map (fun (fun (pairT (vecT ?n0 f32) (vecT ?n0 f32)) (vecT ?n0 f32)) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (arrT ?n3 (vecT ?n0 f32))))) (typeOf ?e2 (fun (pairT (vecT ?n0 f32) (vecT ?n0 f32)) (vecT ?n0 f32)))) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf (app (typeOf zip (fun (arrT ?n3 (vecT ?n0 f32)) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32)))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf fst (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)) (arrT (natMul ?n3 ?n0) f32))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 f32)) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf snd (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)) (arrT (natMul ?n3 ?n0) f32))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 f32)) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))))) (arrT ?n3 (vecT ?n0 f32)))"))))) }),
        rewrite!("vec-before-map-f32x-f32xf32"; "(typeOf (app (typeOf (natApp (typeOf asVector ?tAny) ?n0) ?tAny) (typeOf (app (typeOf (app (typeOf map ?tAny) (typeOf ?e0 (fun (pairT f32 (pairT f32 f32)) f32))) ?tAny) (typeOf ?e1 (arrT ?n1 (pairT f32 (pairT f32 f32))))) (arrT ?n2 f32))) (arrT ?n3 (vecT ?n0 f32)))" => { VectorizeScalarFun::new("?0", "?n0", "?2", Shifted::new("?n3", "?n4", 1, 0, ComputeNatCheck::new("?n1", "(natMul ?n3 ?n0)", ComputeNatCheck::new("?n2", "(natMul ?n3 ?n0)", pat("(typeOf (app (typeOf (app (typeOf map (fun (fun (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (vecT ?n0 f32)) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32)))) (arrT ?n3 (vecT ?n0 f32))))) (typeOf ?e2 (fun (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (vecT ?n0 f32)))) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32)))) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf (app (typeOf zip (fun (arrT ?n3 (vecT ?n0 f32)) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (arrT ?n3 (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32))))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf fst (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))) (arrT (natMul ?n3 ?n0) f32))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (fun (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))) (arrT ?n3 (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32)))))) (typeOf (app (typeOf (app (typeOf zip (fun (arrT ?n3 (vecT ?n0 f32)) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32)))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf fst (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)) (arrT (natMul ?n3 ?n0) f32))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 f32)) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (typeOf (app (typeOf snd (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))) (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (fun (arrT ?n3 (vecT ?n0 f32)) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))))) (typeOf (app (typeOf (natApp (typeOf asVector (natFun (fun (arrT (natMul %0 ?n4) f32) (arrT ?n4 (vecT %0 f32))))) ?n0) (fun (arrT (natMul ?n3 ?n0) f32) (arrT ?n3 (vecT ?n0 f32)))) (typeOf (app (typeOf snd (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)) (arrT (natMul ?n3 ?n0) f32))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 f32)) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (typeOf (app (typeOf snd (fun (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))) (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (typeOf (app (typeOf unzip (fun (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (typeOf ?e1 (arrT (natMul ?n3 ?n0) (pairT f32 (pairT f32 f32))))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) (pairT f32 f32))))) (arrT (natMul ?n3 ?n0) (pairT f32 f32)))) (pairT (arrT (natMul ?n3 ?n0) f32) (arrT (natMul ?n3 ?n0) f32)))) (arrT (natMul ?n3 ?n0) f32))) (arrT ?n3 (vecT ?n0 f32)))) (arrT ?n3 (pairT (vecT ?n0 f32) (vecT ?n0 f32))))) (arrT ?n3 (pairT (vecT ?n0 f32) (pairT (vecT ?n0 f32) (vecT ?n0 f32)))))) (arrT ?n3 (vecT ?n0 f32)))"))))) }),
