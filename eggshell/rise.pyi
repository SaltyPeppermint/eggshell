...
def eqsat_guide_check(start:RecExpr, goal:RecExpr, iter_limit:typing.Optional[builtins.int]=None, node_limit:typing.Optional[builtins.int]=None, time_limit:typing.Optional[builtins.float]=None, guides:typing.Sequence[RecExpr]=[]) -> tuple[builtins.str, builtins.int, builtins.bool]: ...

def eqsat_ordered_rules_check(start:RecExpr, goal:RecExpr, iter_limit:typing.Optional[builtins.int]=None, node_limit:typing.Optional[builtins.int]=None, time_limit:typing.Optional[builtins.float]=None, ordered_rules:typing.Sequence[builtins.str]=[]) -> tuple[builtins.str, builtins.int, builtins.bool]: ...
